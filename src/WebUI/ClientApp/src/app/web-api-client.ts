...
export interface ICodeExecutionClient {
    executeCode(code: string): Observable<FileResponse>;
}

@Injectable({
    providedIn: 'root'
})
export class CodeExecutionClient implements ICodeExecutionClient {
    ...
    executeCode(code: string): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/CodeExecution";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processExecuteCode(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processExecuteCode(response_ as any);
                } catch (e) {
    ...
    protected processExecuteCode(response: HttpResponseBase): Observable<FileResponse> {
